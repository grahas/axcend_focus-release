...
Name:           ros-humble-axcend-focus-custom-interfaces
Version:        3.1.8
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS axcend_focus_custom_interfaces package
...
%description
Standard interfaces for interacting with the Axcend Focus LC
